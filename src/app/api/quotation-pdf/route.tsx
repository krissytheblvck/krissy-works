...
const styles = StyleSheet.create({
  ...
  quoteTitle: { fontSize: 16, fontFamily: 'Helvetica-Bold', textAlign: 'right' },
  quoteRef: { fontSize: 8, color: '#6b7280', textAlign: 'right', marginTop: 2 },
...
export async function POST(req: NextRequest) {
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          ...
          <View>
            ...
            <Text style={styles.quoteRef}>Date: {data.date}</Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.sectionBlock}>
            ...
            <Text style={styles.valueSub}>Valid until: {data.valid_until}</Text>
          </View>
        </View>
        ...
        {/* Client-facing categories — no internal unit prices exposed */}
        ...
        <View style={{ marginBottom: 4 }}>
          ...
          <View style={styles.footerRow}>
            ...
            <Text style={styles.footerValue}>{data.timeline_weeks} weeks from deposit payment</Text>
          </View>
          <View style={styles.footerRow}>
        ...
        <View style={styles.watermark}>
          ...
          <Text style={styles.watermarkText}>{data.quote_number}</Text>
        </View>
      </Page>
    </Document>
  )
  ...
  return new NextResponse(new Uint8Array(pdf), {
    headers: {
      ...
      'Content-Disposition': `attachment; filename="${data.project_code}_quotation.pdf"`,
    },
  })
}
