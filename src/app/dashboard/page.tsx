    ...
    if (requireSupabase) {
      return (
        <main className="max-w-7xl mx-auto px-6 py-16 text-center">
          <h1 className="text-xl font-bold text-gray-900">Database connection required</h1>
          <p className="mt-2 text-sm text-gray-600">
            Set <code className="font-mono bg-gray-100 px-1 rounded">NEXT_PUBLIC_SUPABASE_URL</code> and{' '}
            <code className="font-mono bg-gray-100 px-1 rounded">NEXT_PUBLIC_SUPABASE_ANON_KEY</code> in{' '}
            <code className="font-mono bg-gray-100 px-1 rounded">.env.local</code>.
            See <code className="font-mono bg-gray-100 px-1 rounded">.env.example</code> and the README.
          </p>
        </main>
      )
    }
