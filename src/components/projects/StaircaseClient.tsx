      ...
      <header className="bg-white border-b border-gray-200 px-6 py-4 shrink-0">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex gap-2">
            {!isDemo && (
              <Button variant="secondary" size="sm" onClick={handleSave} disabled={saving || !isComplete}>
                <Save size={14} /> {saving ? 'Saving...' : saved ? 'Saved ✓' : 'Save'}
              </Button>
            )}
            <Button variant="secondary" size="sm" onClick={downloadGrasshopperFile} disabled={!isComplete}>
              ...
              <Card>
                ...
                <CardContent className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  <div className="flex flex-col gap-1">
                    <label className="text-sm font-medium text-gray-700">Number of Flights</label>
                  ...
                  <div className="flex flex-col gap-1">
                    <label className="text-sm font-medium text-gray-700">Rail Sides *</label>
                    <select className="w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-gray-900"
                            ...
                            return (
                              <tr key={opt.num_sections}
                                ...
                                <td className="px-3 py-2.5 text-right">
                                  ...
                                  {isChosen && (
                                    <span className="text-xs bg-white text-gray-900 px-1.5 py-0.5 rounded font-medium">✓</span>
                                  )}
                                  {!opt.structural && (
                    ...
                    <table className="w-full text-sm">
                      ...
                      <tfoot>
                        <tr className="bg-gray-50 border-t border-gray-200">
                          <td colSpan={4} className="px-6 py-3 text-sm font-semibold text-gray-700">Materials + Labor Subtotal</td>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      {!isGlassOnly && (survey.infill_type === 'plain_sheet' ? (
                        <div className="flex flex-col gap-1">
                          <label className="text-sm font-medium text-gray-700">
                            CNC / Laser Cutting
                            {estimation && <span className="text-xs text-gray-400 ml-1">— {estimation.total_sheets} sheet(s) = {formatCurrency(cncCuttingCost)}</span>}
                          </label>
                      ...
                      {!isGlassOnly && (
                        <div className="flex flex-col gap-1">
                          <label className="text-sm font-medium text-gray-700">
                            Welding Consumables
                            {estimation && <span className="text-xs text-gray-400 ml-1">= {formatCurrency(consumablesCost)}</span>}
                          </label>
                          <div className="flex gap-2 items-center">
